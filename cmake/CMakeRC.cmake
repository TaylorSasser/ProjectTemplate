...
write_basic_package_version_file(
    ${CMAKE_CURRENT_BINARY_DIR}/cmrc-base_config_version.cmake
...
export(
    EXPORT cmrc-base-targets
    FILE ${CMAKE_CURRENT_BINARY_DIR}/cmrc-base-targets.cmake
    NAMESPACE cmrc-base::
)
...
function(cmrc_add_resource_library name)
    ...
    include(CMakePackageConfigHelpers)
    write_basic_package_version_file(
            ${CMAKE_CURRENT_BINARY_DIR}/${name}_config_version.cmake
            VERSION ${PROJECT_VERSION}
            COMPATIBILITY AnyNewerVersion
    )
    ...
    export(
        EXPORT ${name}_targets
        FILE ${CMAKE_CURRENT_BINARY_DIR}/${name}_targets.cmake
        NAMESPACE ${name}::
    )
